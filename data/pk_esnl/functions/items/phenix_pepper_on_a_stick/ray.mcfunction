...
execute unless block ~ ~ ~ #pk_core:traversable run scoreboard players set @s PKRaycastHit 1
...
execute if entity @s[scores={PKRaycastHit=0,PKRaycastDist=..29}] positioned ^ ^ ^0.2 run function pk_esnl:items/phenix_pepper_on_a_stick/ray