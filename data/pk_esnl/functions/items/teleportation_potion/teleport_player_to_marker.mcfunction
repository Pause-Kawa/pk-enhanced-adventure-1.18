...
execute as @p[tag=pk_consumed_tp_potion] unless score @s PKMemorizedPDim matches -1.. at @s in minecraft:overworld positioned as @s run tp @s ~ ~ ~

# If a memorized point has been set, teleport the player in the right dimension
execute as @p[tag=pk_consumed_tp_potion,scores={PKMemorizedPDim=0}] at @s in minecraft:overworld positioned as @s run tp @s ~ ~ ~
execute as @p[tag=pk_consumed_tp_potion,scores={PKMemorizedPDim=-1}] at @s in minecraft:the_nether positioned as @s run tp @s ~ ~ ~
execute as @p[tag=pk_consumed_tp_potion,scores={PKMemorizedPDim=1}] at @s in minecraft:the_end positioned as @s run tp @s ~ ~ ~
