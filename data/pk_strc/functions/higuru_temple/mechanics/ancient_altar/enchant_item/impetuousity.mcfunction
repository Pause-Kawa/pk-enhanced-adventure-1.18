...
data modify storage pk_temp Items[1].tag.pkImpetuousity set value 1b
data modify storage pk_temp Items[1].tag.display.Lore prepend value '{"text":"Impetuosity","color":"yellow","italic":false}'
