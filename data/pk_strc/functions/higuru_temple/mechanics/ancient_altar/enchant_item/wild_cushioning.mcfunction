...
data modify storage pk_temp Items[1].tag.pkWildCushioning set value 1b
data modify storage pk_temp Items[1].tag.display.Lore prepend value '{"text":"Wild Cushioning","color":"yellow","italic":false}'
