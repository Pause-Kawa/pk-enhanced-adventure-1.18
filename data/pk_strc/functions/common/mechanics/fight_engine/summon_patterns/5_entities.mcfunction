...
execute positioned ~0.71 ~ ~0.23 run function pk_strc:common/mechanics/fight_engine/summon_entity
data modify storage pk_strc:current_fight_data SpawnEntity[] set from storage pk_strc:current_fight_data Entities[2]
execute positioned ~0.44 ~ ~-0.60 run function pk_strc:common/mechanics/fight_engine/summon_entity
