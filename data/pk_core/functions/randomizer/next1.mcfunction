...
scoreboard players operation %pk_RNG_1 PKValue = %pk_randomizer_seed PKValue
scoreboard players operation %pk_RNG_1 PKValue /= %pk_const_100 PKValue
scoreboard players operation %pk_RNG_1 PKValue %= %pk_randomizer_max PKValue